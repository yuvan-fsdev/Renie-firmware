...
class TinyGsmA7670 : public TinyGsmModem<TinyGsmA7670>,
 ...
 public:
  ...
  bool disableGPS(int8_t power_en_pin ,uint8_t disbale_level) {
    if(power_en_pin!= -1){
  ...
  bool configNMEASentence(bool CGA,bool GLL,bool GSA,bool GSV,bool RMC,bool VTG,bool ZDA,bool ANT){
      char buffer[32];
